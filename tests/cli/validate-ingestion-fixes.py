...
def validate_auto_detection():
    ...
    try:
        ...
        print_result(
            "File detection method", "✅ Present" if has_file_detection else "❌ Missing"
        )
        print_result(
            "URL detection method", "✅ Present" if has_url_detection else "❌ Missing"
        )
