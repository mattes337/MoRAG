...
class SummarizationResult(BaseModel):
    ...
    summary_type: str = Field(
        ..., description="Type of summary (domain-specific, LLM-generated)"
    )
    compression_ratio: float = Field(..., description="Compression ratio")
    confidence: str = Field(
        ..., description="Confidence in summary (domain-specific, LLM-generated)"
    )
...
class ResponseGenerationResult(BaseModel):
    ...
    response_type: str = Field(
        ..., description="Type of response (domain-specific, LLM-generated)"
    )
    sources: List[str] = Field(default_factory=list, description="Sources used")
    confidence: str = Field(
        ..., description="Confidence in response (domain-specific, LLM-generated)"
    )
...
class ExplanationResult(BaseModel):
    ...
    explanation_type: str = Field(
        ..., description="Type of explanation (domain-specific, LLM-generated)"
    )
    ...
    confidence: str = Field(
        ..., description="Confidence in explanation (domain-specific, LLM-generated)"
    )
    metadata: Dict[str, Any] = Field(
        default_factory=dict, description="Additional metadata"
    )
...
class SynthesisResult(BaseModel):
    ...
    confidence: str = Field(
        ..., description="Confidence in synthesis (domain-specific, LLM-generated)"
    )
    metadata: Dict[str, Any] = Field(
        default_factory=dict, description="Additional metadata"
    )
