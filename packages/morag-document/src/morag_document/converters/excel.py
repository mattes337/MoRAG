"""Excel document converter using markitdown."""
...
class ExcelConverter(MarkitdownConverter):
    """Excel document converter using markitdown framework."""

    def __init__(self):
        """Initialize Excel converter."""
        super().__init__()
        self.supported_formats: Set[str] = {"excel", "xlsx", "xls"}
