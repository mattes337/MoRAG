"""Word document converter using markitdown."""
...
class WordConverter(MarkitdownConverter):
    """Word document converter using markitdown framework."""

    def __init__(self):
        """Initialize Word converter."""
        super().__init__()
        self.supported_formats: Set[str] = {"word", "docx", "doc"}
