...
class TestQueryEntityExtractor:
    ...
    async def test_similarity_threshold(self, query_extractor, mock_entity_extractor, mock_graph_storage):
        ...
        query_entity = Entity(name="Einstein", type=EntityType.PERSON, confidence=0.9)
        graph_entity = Entity(id="ent_albert_einstein_person", name="Albert Einstein", type=EntityType.PERSON, confidence=0.95)
    ...
    def test_calculate_entity_similarity(self, query_extractor):
        ...
        graph_entity1 = Entity(name="Einstein", type=EntityType.PERSON)
        ...
        # Partial match
        graph_entity2 = Entity(name="Albert Einstein", type=EntityType.PERSON)
        ...
        graph_entity3 = Entity(name="Einstein", type=EntityType.LOCATION)
