...
class WebFormatter:
    ...
    def format_web_content(
        self, raw_content: str, url: str, metadata: Dict[str, Any]
    ) -> str:
        ...
        page_title = metadata.get(
            "title", self._extract_title_from_content(raw_content)
        )
        if not page_title:
    ...
    def _parse_web_content(self, content: str) -> Dict[str, Any]:
        ...
        """
        sections = {"main_content": "", "subsections": [], "links": []}
    ...
    def _extract_links(self, content: str) -> List[Dict[str, str]]:
        ...
        for text, href in matches:
            ...
            if not href.startswith("#") and not any(
                skip in href.lower() for skip in ["javascript:", "mailto:", "tel:"]
            ):
    ...
    def clean_web_content(self, content: str) -> str:
        ...
        content = re.sub(
            r"(?i)(advertisement|sponsored|related articles?|you may also like)",
            "",
            content,
        )
