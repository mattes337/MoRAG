...
async def process_video(file_path: Union[str, Path],
...
def main():
    ...
    parser.add_argument(
        "--enhanced-audio",
        action="store_true",
        help="Enable enhanced audio processing"
    )
    parser.add_argument(
        "--diarization",
        action="store_true",
    ...
    for file_path in input_files:
        try:
            ...
            result = asyncio.run(process_video(
                ...
                enable_enhanced_audio=args.enhanced_audio or args.diarization or args.topic_segmentation,
