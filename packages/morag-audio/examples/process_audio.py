...
async def process_audio_file(file_path: str, output_dir: str = None, enable_diarization: bool = False):
    ...
    try:
        ...
        if output_dir:
            ...
            if result["success"]:
                ...
                logger.error("Processing failed", error=result.get("error", "Unknown error"))
        else:
