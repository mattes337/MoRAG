...
class Entity(BaseModel):
    ...
    start_pos: Optional[int] = Field(
        default=None, description="Start position in the text"
    )
...
class Relation(BaseModel):
    ...
    context: Optional[str] = Field(
        default=None, description="Context where the relation was found"
    )
    metadata: Dict[str, Any] = Field(
        default_factory=dict, description="Additional metadata"
    )
...
class TopicBoundary(BaseModel):
    ...
    topic_before: Optional[str] = Field(
        default=None, description="Topic before the boundary"
    )
    topic_after: Optional[str] = Field(
        default=None, description="Topic after the boundary"
    )
...
class TranscriptAnalysisResult(BaseModel):
    ...
    sentiment_timeline: List[Dict[str, Any]] = Field(
...
class BaseAgentResult(BaseModel):
    ...
    agent_version: Optional[str] = Field(
        default=None, description="Version of the agent that generated this result"
    )
