...
class DatabaseHandler:
    ...
    async def cleanup_connections(self):
        ...
        async with self._pool_lock:
            ...
            logger.info(
                f"Connection cleanup completed",
            ...
            if cleanup_errors:
                logger.warning(
                    f"Connection cleanup had {len(cleanup_errors)} errors",
    ...
    async def write_to_databases(
        self, database_configs: List[DatabaseConfig], ingest_data: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    async def _write_to_qdrant(
        self, db_config: DatabaseConfig, ingest_data: Dict[str, Any]
    ) -> Dict[str, Any]:
