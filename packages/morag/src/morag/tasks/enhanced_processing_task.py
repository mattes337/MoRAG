...
def enhanced_process_ingest_task(
    ...
    async def _process():
        ...
        try:
            ...
            if webhook_url and not webhook_service.validate_webhook_url(
                webhook_url, allow_localhost=True
            ):
            ...
            logger.info(
                "Starting enhanced processing task",
                task_id=task_id,
            ...
            logger.info(
                "Enhanced processing task completed successfully",
                task_id=task_id,
                document_id=document_id,
            ...
            logger.error(
                "Enhanced processing task failed",
                task_id=task_id,
                document_id=document_id,
                error=str(e),
            )
